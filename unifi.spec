...
Provides:       bundled(jboss-logging) = 3.6.1.Final
...
Provides:       bundled(logback-classic) = 1.5.21
Provides:       bundled(logback-core) = 1.5.21
Provides:       bundled(mapstruct) = 1.6.2
Provides:       bundled(micrometer-commons) = 1.15.6
Provides:       bundled(micrometer-observation) = 1.15.6
...
Provides:       bundled(reactor-core) = 3.7.13
...
Provides:       bundled(spring-boot-starter-validation) = 3.5.8
Provides:       bundled(spring-boot-starter-web) = 3.5.8
Provides:       bundled(spring-boot-starter-websocket) = 3.5.8
...
Provides:       bundled(spring-webmvc) = 6.2.14
Provides:       bundled(spring-websocket) = 6.2.14
Provides:       bundled(sshj) = 0.39.0
Provides:       bundled(stax-api-1.0) = 2
Provides:       bundled(tomcat-annotations-api) = 10.1.49
Provides:       bundled(tomcat-embed-core) = 10.1.49
Provides:       bundled(tomcat-embed-el) = 10.1.49
Provides:       bundled(tomcat-embed-websocket) = 10.1.49
