...
Provides:       bundled(bson) = 4.11.1
Provides:       bundled(bson-record-codec) = 4.11.1
...
Provides:       bundled(commons-net) = 3.10.0
Provides:       bundled(commons-text) = 1.11.0
Provides:       bundled(commons-validator) = 1.7
...
Provides:       bundled(httpcore5) = 5.2.4
Provides:       bundled(httpcore5-h2) = 5.2.4
...
Provides:       bundled(jakarta.activation) = 2.0.1
Provides:       bundled(jakarta.annotation-api) = 2.1.1
Provides:       bundled(jakarta.mail) = 2.0.1
...
Provides:       bundled(jcl-over-slf4j) = 2.0.12
...
Provides:       bundled(jul-to-slf4j) = 2.0.12
...
Provides:       bundled(micrometer-commons) = 1.12.3
Provides:       bundled(micrometer-observation) = 1.12.3
Provides:       bundled(minimal-json) = 0.9.5
Provides:       bundled(mongodb-driver-core) = 4.11.1
Provides:       bundled(mongodb-driver-legacy) = 4.11.1
Provides:       bundled(mongodb-driver-sync) = 4.11.1
...
Provides:       bundled(reactor-core) = 3.6.3
Provides:       bundled(resource-loader) = 2.0.2
Provides:       bundled(slf4j-api) = 2.0.12
Provides:       bundled(snakeyaml) = 2.2
Provides:       bundled(snappy-java) = 1.1.10.5
Provides:       bundled(spring-aop) = 6.1.4
Provides:       bundled(spring-beans) = 6.1.4
Provides:       bundled(spring-boot) = 3.2.3
Provides:       bundled(spring-boot-autoconfigure) = 3.2.3
Provides:       bundled(spring-boot-starter) = 3.2.3
Provides:       bundled(spring-boot-starter-data-mongodb) = 3.2.3
Provides:       bundled(spring-boot-starter-json) = 3.2.3
Provides:       bundled(spring-boot-starter-logging) = 3.2.3
Provides:       bundled(spring-boot-starter-tomcat) = 3.2.3
Provides:       bundled(spring-boot-starter-validation) = 3.2.3
Provides:       bundled(spring-boot-starter-web) = 3.2.3
Provides:       bundled(spring-boot-starter-websocket) = 3.2.3
Provides:       bundled(spring-context) = 6.1.4
Provides:       bundled(spring-core) = 6.1.4
Provides:       bundled(spring-data-commons) = 3.2.3
Provides:       bundled(spring-data-mongodb) = 4.2.3
Provides:       bundled(spring-expression) = 6.1.4
Provides:       bundled(spring-messaging) = 6.1.4
Provides:       bundled(spring-tx) = 6.1.4
Provides:       bundled(spring-web) = 6.1.4
Provides:       bundled(spring-webmvc) = 6.1.4
Provides:       bundled(spring-websocket) = 6.1.4
Provides:       bundled(sshj) = 0.37.0
Provides:       bundled(tomcat-annotations-api) = 10.1.19
Provides:       bundled(tomcat-embed-core) = 10.1.19
Provides:       bundled(tomcat-embed-el) = 10.1.19
Provides:       bundled(tomcat-embed-jasper) = 10.1.19
Provides:       bundled(tomcat-embed-websocket) = 10.1.19
